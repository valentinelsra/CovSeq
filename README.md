...
Little script Bash running the Nextclade and Pangolin docker images with multi.fasta file from the latest output of sars-cov-2 artic pipeline. Tested on MacOS.
